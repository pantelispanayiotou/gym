...
<html lang="en">
    <head>
    <head>
  <title>MS Fit Care Gym | Edit Program</title>
  <meta charset="utf-8">
...
<?php } ?>
  ...
  <div class="container text-center">
    ...
    $fetched_ann=mysqli_fetch_array($fetch_ann); ?>
            ...
            <h5 class="card-title text-center">Add a New Program</h5>
              <?php
            if ($message != "") {
                echo '<div class="alert alert-danger"><strong></strong> ' . $message . '</div>';
            }
            ?>
            <form action="programE.php" method="post" enctype="multipart/form-data" class="form-signin">
